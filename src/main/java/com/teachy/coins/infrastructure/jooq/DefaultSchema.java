...
public class DefaultSchema extends SchemaImpl {
     ...
     */
    public final Hosts HOSTS = com.teachy.coins.infrastructure.jooq.tables.Hosts.HOSTS;

    /**
     * The table <code>ip_list</code>.
     */
    public final IpList IP_LIST = com.teachy.coins.infrastructure.jooq.tables.IpList.IP_LIST;

    /**
     * The table <code>sources</code>.
     */
    public final Sources SOURCES = com.teachy.coins.infrastructure.jooq.tables.Sources.SOURCES;

    /**
     * 爬虫基本信息
     */
    public final SpiderBase SPIDER_BASE = com.teachy.coins.infrastructure.jooq.tables.SpiderBase.SPIDER_BASE;

    /**
     * 爬虫队列
     */
    public final SpiderQueue SPIDER_QUEUE = com.teachy.coins.infrastructure.jooq.tables.SpiderQueue.SPIDER_QUEUE;

    /**
     * The table <code>spider_unique</code>.
     */
    public final SpiderUnique SPIDER_UNIQUE = com.teachy.coins.infrastructure.jooq.tables.SpiderUnique.SPIDER_UNIQUE;

    /**
     * The table <code>spider_url</code>.
     */
    public final SpiderUrl SPIDER_URL = com.teachy.coins.infrastructure.jooq.tables.SpiderUrl.SPIDER_URL;

    /**
     * The table <code>tools</code>.
     */
    public final Tools TOOLS = com.teachy.coins.infrastructure.jooq.tables.Tools.TOOLS;
