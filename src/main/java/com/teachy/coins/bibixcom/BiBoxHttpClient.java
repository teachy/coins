...
import com.teachy.coins.bibixcom.enums.AccountTypeEnum;
import com.teachy.coins.bibixcom.enums.BorrowOrderStatusEnum;
import com.teachy.coins.bibixcom.enums.COrderSideEnum;
import com.teachy.coins.bibixcom.enums.CTypeEnum;
import com.teachy.coins.bibixcom.enums.DepositListFilterTypeEnum;
import com.teachy.coins.bibixcom.enums.KLinePeriodEnum;
import com.teachy.coins.bibixcom.enums.LendOrderBookStatusEnum;
import com.teachy.coins.bibixcom.enums.LendOrderStatusEnum;
import com.teachy.coins.bibixcom.enums.OrderSideEnum;
import com.teachy.coins.bibixcom.enums.OrderTypeEnum;
import com.teachy.coins.bibixcom.enums.TransferSpotTypeEnum;
import com.teachy.coins.bibixcom.proxy.V1CTradeProxy;
import com.teachy.coins.bibixcom.proxy.V1CTradeQueryProxy;
import com.teachy.coins.bibixcom.proxy.V1CreditProxy;
import com.teachy.coins.bibixcom.proxy.V1MDataProxy;
import com.teachy.coins.bibixcom.proxy.V1OrderPendingProxy;
import com.teachy.coins.bibixcom.proxy.V1TransferProxy;
import com.teachy.coins.bibixcom.proxy.V2AssetsTransferSpotProxy;
import com.teachy.coins.bibixcom.utils.HttpClientHelper;
import com.teachy.coins.bibixcom.vo.BorrowOrderBookParams;
import com.teachy.coins.bibixcom.vo.BorrowOrderGetParams;
import com.teachy.coins.bibixcom.vo.CQueryOrderListParams;
import com.teachy.coins.bibixcom.vo.CQueryOrderPendingParams;
import com.teachy.coins.bibixcom.vo.CTradeOrderOpenParams;
import com.teachy.coins.bibixcom.vo.LendOrderBookGetParams;
import com.teachy.coins.bibixcom.vo.LendOrderGetParams;
import com.teachy.coins.bibixcom.vo.LendPublishParams;
import com.teachy.coins.bibixcom.vo.OrderPendingHistoryListParams;
import com.teachy.coins.bibixcom.vo.OrderPendingListParams;
import com.teachy.coins.bibixcom.vo.TradeParams;
...
public class BiBoxHttpClient
{
    ...
    {
        String apiKey = "bbc37ad215c7ee30bbad751c35dbc07b6fcf33c6";
        String secret = "3b4dd83b4180aafe4747a36f8f86f5f7afe89f59";
        // 不需要apikey
