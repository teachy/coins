package com.teachy.coins.gateio.restApi.impl;
...
import com.teachy.coins.gateio.httpUtil.HttpUtilManager;
import com.teachy.coins.gateio.restApi.IStockRestApi;

public class StockRestApiImpl implements IStockRestApi {

	private String url_prex;

	public StockRestApiImpl(String url_prex) {
		this.url_prex = url_prex;
	}

	private final String PAIRS_URL = "/api2/1/pairs";

	private final String MARKETINFO_URL = "/api2/1/marketinfo";

	private final String MARKETLIST_URL = "/api2/1/marketlist";

	private final String TICKERS_URL = "/api2/1/tickers";

	private final String TICKER_URL = "/api2/1/ticker";

	private final String ORDERBOOK_URL = "/api2/1/orderBook";

	private final String BALANCE_URL = "/api2/1/private/balances";
	...
	private final String CANDLESTICK2_URL = "/api2/1/candlestick2/";
