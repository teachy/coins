package com.teachy.coins.gateio.httpUtil;
...
public class HttpUtilManager {
	...
	public String requestHttpPost(String url_prex, String url, Map<String, String> params) throws
		HttpException,
		IOException {
	...
	public String doRequest(String api, String requestType, String url, Map<String, String> arguments) throws
		HttpException,
		IOException {
