package com.teachy.coins.huobi.common.api;

import com.teachy.coins.huobi.common.request.Order;
...
public class HbdmClient {
    ...
    public static void main(String[] args) throws HttpException, IOException {
         ...
         */
        String api_key = "12345678"; // huobi申请的apiKey,API调试过程中有问题或者有疑问可反馈微信号shaoxiaofeng1118
        String secret_key = "12345679"; // huobi申请的secretKey
        String url_prex = "https://api.btcgateway.pro/";//火币api接口地址https://api.hbdm.com
